...
console.log(removeFirstLast("safa"));
...
function accum(str) {
    ...
    for (let i = 0; i < str.length; i++) {
        let newStr = str[i].toUpperCase() + str[i].toLowerCase().repeat(i);
        result.push(newStr);
    }
    return result.join("-");
}
...
console.log(cntDublicate("abcde"));
console.log(cntDublicate("aabbcde"));
console.log(cntDublicate("aabBcde"));
console.log(cntDublicate("indivisibility"));
console.log(cntDublicate("Indivisibilities"));
